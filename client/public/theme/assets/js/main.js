!(function (e) {
  ...
  a.on("load", function () {
    ...
    o.delay("500").fadeOut(2e3),
      ...
      t.on("click", ".drop-menu-toggle", function () {
        ...
        return (
          ...
          a.parent().parent().children(".dropdown-menu-item").toggle(),
          !1
        );
      }),
      a.on("resize", function () {
        a.width() > 1200
          ? (e(".main-menu-content").show(), e(".dropdown-menu-item").show())
          : (e(".main-menu-content").hide(), e(".dropdown-menu-item").hide());
      }),
    ...
    for (
      var j = document.querySelectorAll(".payment-tab-toggle > input"), q = 0;
      q < j.length;
      q++
    )
